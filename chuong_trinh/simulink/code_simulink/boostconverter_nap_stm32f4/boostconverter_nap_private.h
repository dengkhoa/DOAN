/*
 * File: boostconverter_nap_private.h
 *
...
#ifndef RTW_HEADER_boostconverter_nap_private_h_
#define RTW_HEADER_boostconverter_nap_private_h_
#include "rtwtypes.h"
#endif                                 /* RTW_HEADER_boostconverter_nap_private_h_ */
